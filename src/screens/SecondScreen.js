...
<Box 
        title="התמדה"
        description="להצליח דורש התמדה יומיומית בתרגול יומיומי ולא לעצור גם כשהדברים פחות עובדים ופחות הולכים בדרך שלך"
        icon={succsess}
      />
      <Box 
        title="נחישות"
        description="כדי לסיים את הקורס ובאמת לעסוק בתחום גם אחריו את תהיי חייבת להגיע נחושה להצליח! לא לעשות דברים על רגל אחת ולא להעלים עין! את צריכה להגיע עם רעב לטרוף את המקצוע"
        icon={succsess}
      />
      <Box 
        title="סבלנות"
